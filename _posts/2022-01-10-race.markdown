---
layout:     post
title:      "Embracing racial bias in AI"
date:       2022-01-10 12:00:00
author:     "Matt Christian"
header-img: "img/cover.jpeg"
---
Embracing racial bias in AI. Obviously, one shouldn’t include race and gender as an input for a model that predicts creditworthiness. In the healthcare space, the issue is significantly more complicated as race and gender SHOULD be inputs to these AI models. There is a need to analyze the impacts of these models through gender/racial lenses, particularly for unbalanced classes.  Historically, African Americans have been underrepresented in drug trials such as the COVID vaccine. 
